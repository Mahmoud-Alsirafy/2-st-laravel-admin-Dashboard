          ...
          <div class="col-lg-3 col-12">
            <div class="product-sidebar">
              ...
              <div class="single-widget">
                ...
                <ul class="list">
                  <li>
                    <a href="{{ route('grid') }}">Computers & Accessories </a
                    ><span>(1138)</span>
                  </li>
                  <li>
                    <a href="{{ route('grid') }}">Smartphones & Tablets</a
                    ><span>(2356)</span>
                  </li>
                  <li>
                    <a href="{{ route('grid') }}">TV, Video & Audio</a
                    ><span>(420)</span>
                  </li>
                  <li>
                    <a href="{{ route('grid') }}">Cameras, Photo & Video</a
                    ><span>(874)</span>
                  </li>
                  <li>
                    <a href="{{ route('grid') }}">Headphones</a
                    ><span>(1239)</span>
                  </li>
                  <li>
                    <a href="{{ route('grid') }}">Wearable Electronics</a
                    ><span>(340)</span>
                  </li>
                  <li>
                    <a href="{{ route('grid') }}">Printers & Ink</a
                    ><span>(512)</span>
                  </li>
                </ul>
              </div>
                  ...
                  <div class="row">
                    <div class="col-lg-4 col-md-6 col-12">
                      <div class="single-product">
                        <div class="product-image">
                          <img
                            src="{{asset('pro')}}/images/products/product-1.jpg"
                            alt="#"
                          />
                          <div class="button">
                            <a href="{{ route('details') }}" class="btn"
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                      <div class="single-product">
                        <div class="product-image">
                          <img
                            src="{{asset('pro')}}/images/products/product-2.jpg"
                            alt="#"
                          />
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                      <div class="single-product">
                        <div class="product-image">
                          <img
                            src="{{asset('pro')}}/images/products/product-3.jpg"
                            alt="#"
                          />
                          <div class="button">
                            <a href="{{ route('details') }}" class="btn"
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                      <div class="single-product">
                        <div class="product-image">
                          <img
                            src="{{asset('pro')}}/images/products/product-4.jpg"
                            alt="#"
                          />
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                      <div class="single-product">
                        <div class="product-image">
                          <img
                            src="{{asset('pro')}}/images/products/product-5.jpg"
                            alt="#"
                          />
                          <div class="button">
                            <a href="{{ route('details') }}" class="btn"
                        ...
                        <div class="product-info">
                          ...
                          <h4 class="title">
                            <a href="{{ route('grid') }}">Wireless Headphones</a>
                          </h4>
                          <ul class="review">
                            <li><i class="lni lni-star-filled"></i></li>
                            <li><i class="lni lni-star-filled"></i></li>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                      <div class="single-product">
                        <div class="product-image">
                          <img
                            src="{{asset('pro')}}/images/products/product-6.jpg"
                            alt="#"
                          />
                          <div class="button">
                            <a href="{{ route('details') }}" class="btn"
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                      <div class="single-product">
                        <div class="product-image">
                          <img
                            src="{{asset('pro')}}/images/products/product-7.jpg"
                            alt="#"
                          />
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                      <div class="single-product">
                        <div class="product-image">
                          <img
                            src="{{asset('pro')}}/images/products/product-8.jpg"
                            alt="#"
                          />
                          <div class="button">
                            <a href="{{ route('details') }}" class="btn"
