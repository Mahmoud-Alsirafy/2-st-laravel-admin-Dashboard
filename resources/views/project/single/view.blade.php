            ...
            <div class="post-details">
              <div class="main-content-head">
                <div class="post-thumbnils">
                  <img src="{{asset('pro')}}/images/blog/blog-single.jpg" alt="#" />
                </div>
                ...
                <ul class="comments-list">
                  <li>
                    <div class="comment-img">
                      <img src="{{asset('pro')}}/images/blog/comment1.jpg" alt="img" />
                    </div>
                  ...
                  <li class="children">
                    <div class="comment-img">
                      <img src="{{asset('pro')}}/images/blog/comment2.jpg" alt="img" />
                    </div>
                    <div class="comment-desc">
                      <div class="desc-top">
                  ...
                  <li>
                    <div class="comment-img">
                      <img src="{{asset('pro')}}/images/blog/comment3.jpg" alt="img" />
                    </div>
                    <div class="comment-desc">
                      <div class="desc-top">
                        <h6>Alex Jemmi</h6>
              ...
              <div class="popular-feed-loop">
                <div class="single-popular-feed">
                  <div class="feed-desc">
                    <a class="feed-img" href="blog-single-sidebar.html">
                      <img
                        src="{{asset('pro')}}/images/blog/blog-sidebar-1.jpg"
                        alt="#"
                      />
                    </a>
                    <h6 class="post-title">
                ...
                <div class="single-popular-feed">
                  <div class="feed-desc">
                    <a class="feed-img" href="blog-single-sidebar.html">
                      <img
                        src="{{asset('pro')}}/images/blog/blog-sidebar-2.jpg"
                        alt="#"
                      />
                    </a>
                    <h6 class="post-title">
                ...
                <div class="single-popular-feed">
                  <div class="feed-desc">
                    <a class="feed-img" href="blog-single-sidebar.html">
                      <img
                        src="{{asset('pro')}}/images/blog/blog-sidebar-3.jpg"
                        alt="#"
                      />
                    </a>
                    <h6 class="post-title">
