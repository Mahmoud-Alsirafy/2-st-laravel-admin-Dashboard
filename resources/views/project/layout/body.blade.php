      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 col-12">
          <div class="single-category">
            ...
            <div class="images">
              <img
                src="{{asset('pro')}}/images/featured-categories/fetured-item-1.png"
                alt="#"
              />
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 col-12">
          <div class="single-category">
            ...
            <div class="images">
              <img
                src="{{asset('pro')}}/images/featured-categories/fetured-item-2.png"
                alt="#"
              />
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 col-12">
          <div class="single-category">
            ...
            <div class="images">
              <img
                src="{{asset('pro')}}/images/featured-categories/fetured-item-3.png"
                alt="#"
              />
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 col-12">
          <div class="single-category">
            ...
            <div class="images">
              <img
                src="{{asset('pro')}}/images/featured-categories/fetured-item-4.png"
                alt="#"
              />
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 col-12">
          <div class="single-category">
            ...
            <div class="images">
              <img
                src="{{asset('pro')}}/images/featured-categories/fetured-item-5.png"
                alt="#"
              />
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 col-12">
          <div class="single-category">
            ...
            <div class="images">
              <img
                src="{{asset('pro')}}/images/featured-categories/fetured-item-6.png"
                alt="#"
              />
            </div>
          </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 col-12">
          <div class="single-product">
            <div class="product-image">
              <img src="{{asset('pro')}}/images/products/product-5.jpg" alt="#" />
              <div class="button">
                <a href="product-details.html" class="btn"
                  ><i class="lni lni-cart"></i> Add to Cart</a
                >
      ...
      <div class="row">
        <div class="col-lg-4 col-md-4 col-12 custom-responsive-margin">
          ...
          <div class="single-list">
            <div class="list-image">
              <a href="product-grids.html"
                ><img src="{{asset('pro')}}/images/home-product-list/01.jpg" alt="#"
              /></a>
            </div>
            <div class="list-info">
              <h3>
          ...
          <div class="single-list">
            <div class="list-image">
              <a href="product-grids.html"
                ><img src="{{asset('pro')}}/images/home-product-list/02.jpg" alt="#"
              /></a>
            </div>
            <div class="list-info">
              <h3>
          ...
          <div class="single-list">
            <div class="list-image">
              <a href="product-grids.html"
                ><img src="{{asset('pro')}}/images/home-product-list/03.jpg" alt="#"
              /></a>
            </div>
            <div class="list-info">
              <h3>
        ...
        <div class="col-lg-4 col-md-4 col-12 custom-responsive-margin">
          ...
          <div class="single-list">
            <div class="list-image">
              <a href="product-grids.html"
                ><img src="{{asset('pro')}}/images/home-product-list/04.jpg" alt="#"
              /></a>
            </div>
            <div class="list-info">
              <h3>
          ...
          <div class="single-list">
            <div class="list-image">
              <a href="product-grids.html"
                ><img src="{{asset('pro')}}/images/home-product-list/05.jpg" alt="#"
              /></a>
            </div>
            <div class="list-info">
              <h3>
          ...
          <div class="single-list">
            <div class="list-image">
              <a href="product-grids.html"
                ><img src="{{asset('pro')}}/images/home-product-list/06.jpg" alt="#"
              /></a>
            </div>
            <div class="list-info">
              <h3>
        ...
        <div class="col-lg-4 col-md-4 col-12">
          ...
          <div class="single-list">
            <div class="list-image">
              <a href="product-grids.html"
                ><img src="{{asset('pro')}}/images/home-product-list/07.jpg" alt="#"
              /></a>
            </div>
            <div class="list-info">
              <h3>
          ...
          <div class="single-list">
            <div class="list-image">
              <a href="product-grids.html"
                ><img src="{{asset('pro')}}/images/home-product-list/08.jpg" alt="#"
              /></a>
            </div>
            <div class="list-info">
              <h3>
          ...
          <div class="single-list">
            <div class="list-image">
              <a href="product-grids.html"
                ><img src="{{asset('pro')}}/images/home-product-list/09.jpg" alt="#"
              /></a>
            </div>
            <div class="list-info">
              <h3>
