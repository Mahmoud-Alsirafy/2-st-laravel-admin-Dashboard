...
<footer class="footer">
          ...
          <div class="row">
            <div class="col-lg-3 col-md-4 col-12">
              <div class="footer-logo">
                <a href="index-2.html">
                  <img src="{{asset('pro')}}/images/logo/white-logo.svg" alt="#" />
                </a>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-lg-3 col-md-6 col-12">
              <div class="single-footer f-contact">
                ...
                <p class="mail">
                  <a
                    href="https://demo.graygrids.com/cdn-cgi/l/email-protection#c4b7b1b4b4abb6b084b7acabb4a3b6ada0b7eaa7aba9"
                    ><span
                      class="__cf_email__"
                      data-cfemail="097a7c7979667b7d497a6166796e7b606d7a276a6664"
          ...
          <div class="row align-items-center">
            <div class="col-lg-4 col-12">
              <div class="payment-gateway">
                <span>We Accept:</span>
                <img
                  src="{{asset('pro')}}/images/footer/credit-cards-footer.png"
                  alt="#"
                />
              </div>
            </div>
  ...
  <script src="{{asset('pro')}}/js/tiny-slider.js"></script>
  <script src="{{asset('pro')}}/js/glightbox.min.js"></script>
